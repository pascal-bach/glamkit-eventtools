...
#         
#         #occurrence page
#         ourl = reverse('event_occurrence', args=(o.id,))
#         self.assertTrue(str(o.id) in ourl)
#         r1 = self.client.get(ourl)
#         self.assertEqual(r1.status_code, 200)
#         self.assertContains(r1.content, "Daily Tour")       
#         self.assertContains(r1.content, "Friday, 1 January, 2010")
#         self.assertNotContains(r1.content, "00:00")
#         self.assertNotContains(r1.content, "12am")
#         self.assertNotContains(r1.content, "midnight")
#         
#         e2 = self.weekly_talk
